...
model_dir = '/media/andres/Windows/Users/andre/Documents/PhD/2026/cylinder_model/simulation/3d/' # the .slf file must be in this directory.
res_dir = '/media/andres/Windows/Users/andre/Documents/PhD/2026/cylinder_model/simulation/' # a dictionary with the model outputs will be saved in this directory
calibration_pts_file_path = '/media/andres/Windows/Users/andre/Documents/PhD/2026/cylinder_model/simulation/measurements-calibration.csv'
output_name='output_file_2d'
calibration_quantities= ['WATER DEPTH','VELOCITY U'] #['TURBULENT ENERG','DISSIPATION'] 
extraction_quantities= ['WATER DEPTH','VELOCITY U'] #['TURBULENT ENERG','DISSIPATION'] 
input_slf_file='3d-ref-2.5cm-0.5-2d-GMRES-2-TEST.slf' # the .slf file must be in model_dir
...
control_tm.output_processing(output_data_path=os.path.join(control_tm.calibration_folder,f'{output_name}-detailed.json'),calibration_quantities=control_tm.calibration_quantities)
