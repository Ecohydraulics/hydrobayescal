...
# Command 4: Run with WATER DEPTH and SCALAR VELOCITY
echo "Running with calibration_quantities: WATER DEPTH and SCALAR VELOCITY, complete_bal_mode: True, only_bal_mode: True"
python bal_telemac.py --calibration_quantities "WATER DEPTH" "SCALAR VELOCITY" --complete_bal_mode True --only_bal_mode True
