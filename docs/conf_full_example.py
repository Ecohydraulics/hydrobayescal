...
ogp_site_name = "HydroBayesCal"
ogp_use_first_image = True  # https://github.com/readthedocs/blog/pull/118
ogp_image = "https://github.com/Ecohydraulics/hydrobayescal/blob/main/docs/img/browser-icon-large.jpg?raw=true"
...
latex_documents = [
    (
        ...
        "ReadTheDocs.tex",
        "HydroBayesCal",
        "Andrés Heredia, Federica Scolari, Sebastian Schwindt",
        "manual",
    ),
]
man_pages = [
