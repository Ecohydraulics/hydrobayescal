...
# simple progress bar with no external dependencies
# if wanting to whole numbers, change to
# p = round(100*_cur/_max)
# after the loop that calls progress bar, print an empty line to make
# the output nice
def progress(_cur, _max):
  # this will report progress to the decimal
  p = round(1000*_cur/_max)/10
  b = f'Progress: {p}% ['+'#'*int(p/2.5)+' '*(40-int(p/2.5))+']'
  print(b, end='\r')
