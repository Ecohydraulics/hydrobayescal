...
#
# Revised: Jun 8, 2023
# Got rid of dependency on progress bar, and instead implemented a simpler
# version in utilities.py.
#
...
from ppmodules.readMesh import readAdcirc  # to get all readMesh functions
...
if len(sys.argv) != 7 :
  ...
  print('Usage:')
  print('assign_mpl.py -i out.grd -b boundary.csv -o out_friction.grd')
  sys.exit()
dummy1 =  sys.argv[1]
...
for i in range(n_polygons):
  ...
  for k in range(n):
    ...
    progress(count_bar,n_polygons*n)
