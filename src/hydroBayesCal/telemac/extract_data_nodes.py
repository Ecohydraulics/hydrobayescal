...
def main():
    ...
    file_name = '/home/IWS/hidalgo/Documents/hydrobayescal/examples/ering/geometry_friction.slf'  # Replace with the path to your SELEFIN file
    ...
    save_name = '/home/IWS/hidalgo/Documents/hydrobayescal/examples/ering/friction_ID.bfr.txt'  # Replace with the desired output file name (or leave empty if you don't want to save)
