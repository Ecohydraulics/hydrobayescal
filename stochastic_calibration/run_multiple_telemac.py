"""
Run multiple hydro-morphodynamic Telemac2d simulations using a list of parameter combinations by providing a
parameter combination workbook (e.g. parameter-comb.xlsx). The code can be adapted to optimize other
numerical model configurations (e.g. bedload transport).
"""
